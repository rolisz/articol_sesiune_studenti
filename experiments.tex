...
\label{sec:exp}
In this section we describe the experiments we have done, starting with the data gathering process, the training of the models and the results of their evaluation.
