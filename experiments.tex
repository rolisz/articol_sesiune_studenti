...
For the character recognition problem, using a RBF kernel SVM resulted in a 91\% \plusminus 0.126 error rate in the best case, using a value of 100 for the regularization rate, while using a linear kernel yielded 90.490\% \plusminus 0.097 as its best result, for the value of 1 for the regularization rate. Using a RBF kernel seems to be better. 