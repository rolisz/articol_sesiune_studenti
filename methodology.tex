...
The SVM was used for the character recognition problem. A linear kernel was used, so there was no projecting of data into a higher dimensional space. 

The regularization parameter of the linear SVM was determined using cross-validation. 
